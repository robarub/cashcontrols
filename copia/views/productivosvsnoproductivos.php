      ...
      <div class="row">
        ...
        <div class="col-sm-9 mt-4 admin">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-grapic-income">Ing. Productos Vs Ing. No Productivos</button>
              </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-3 align-self-center">
              ...
              <div class="text-income mt-2">Ingresos 65%</div>
            </div>
          </div>
          <div class="row">
              ...
              <div class="table-detail-graphic">
                <table class="table table-bordered table-sm" cellspacing="0" width="100%">
                  <thead class="thead-dark">
                    <tr>
                      <th scope="col">Ingresos Productivos</th>
                      <th scope="col">Ingresos No Productivos</th>
