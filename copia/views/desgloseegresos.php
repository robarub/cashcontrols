    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 mt-4 admin">
          <div class="row">
            ...
            <div class="col-sm-4">
              <button type="button" class="btn btn-block btn-grapic-income">Desglose de Egresos</button>
              <div class="d-flex justify-content-between mt-4">
                <button type="button" class="btn value active">Gasto</button>
                <button type="button" class="btn value">Inversión</button>
              </div>
            ...
            <div class="col-3 align-self-center">
              ...
              <div class="text-income mt-2 py-2">
                <div class="d-flex justify-content-between">
                  <span>Egresos Gasto</span>
                  <span>65%</span>
                </div>
                <div class="d-flex justify-content-between">
                  <span>Egresos Inversión</span>
                  <span>35%</span>
                </div>
              </div>
            </div>
      ...
      <script>
        anychart.onDocumentLoad(function () {
          ...
          var data = [
            { x: "January", value: 10000, info: "EGRESOS GASTO" },
            { x: "February", value: 12000, info: "EGRESOS INVERSIÓN" }
          ];
