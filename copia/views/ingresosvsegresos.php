    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 mt-4 admin">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-grapic-income">Gráfica por Ingresos y Egresos</button>
              </div>
      ...
      <script>
        anychart.onDocumentLoad(function () {
          ...
          var data = [
            { x: "January", value: 10000, info: "INGRESOS" },
            { x: "February", value: 12000, info: "EGRESOS" }
          ];
