		...
		<div class="row">
			...
			<div class="col-sm-9 mt-4 admin">
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="d-flex justify-content-center">
							<button type="button" class="btn btn-grapic-income">Grafica Por Clasificacion Egresos
							</button>
						</div>
						<!--<div class="row mt-5">
	...
	$(document).ready(function () {
		...
		$("#btnfE").on("click", function () {
			$.ajax({
				...
				url: "../../actividades/graficaclasificacionegresos/1",
				success: function (response) {
					...
					if (response != 0) {
						...
						var data = [
							{x: "No Productivo", value: dataValores[0].porcentajeProductivo.toFixed(), info: "No Productivo"},
							{x: "Inversion", value: dataValores[0].porcentajeNoProductivo.toFixed(), info: "Inversion"},
		...
		$("#btnpe").on("click", function () {
			$.ajax({
				...
				url: "../../actividades/graficaclasificacionegresos/2",
				success: function (response) {
					if (response != 0) {
						dataValores = JSON.parse(response);
						// create an instance of a pie chart
		...
		$("#btnMa").on("click", function () {
			$.ajax({
				...
				url: "../../actividades/graficaclasificacionegresos/3",
				success: function (response) {
					if (response != 0) {
						dataValores = JSON.parse(response);
						// create an instance of a pie chart
